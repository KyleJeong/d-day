 ...
 */
public class selectActivity4 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            RemoteViews views = new RemoteViews(getApplicationContext().getPackageName(), R.layout.dday_widget4);
