 ...
 */
public class ddayProvider4 extends AppWidgetProvider {
    ...
    public void Onupdate(Context context,AppWidgetManager appWidgetManager, int appWidgetIds){
        ...
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.dday_widget4);
        ...
        Intent intent = new Intent(context, ddayProvider4.class);
