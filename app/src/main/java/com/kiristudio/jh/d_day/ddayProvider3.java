 ...
 */
public class ddayProvider3 extends AppWidgetProvider {
    ...
    public void Onupdate(Context context,AppWidgetManager appWidgetManager, int appWidgetIds){
        ...
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.dday_widget3);
        ...
        Intent intent = new Intent(context, ddayProvider3.class);
