 ...
 */
public class ddayProvider2 extends AppWidgetProvider {
    ...
    public void Onupdate(Context context,AppWidgetManager appWidgetManager, int appWidgetIds){
        ...
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.dday_widget2);
        ...
        Intent intent = new Intent(context, ddayProvider2.class);
